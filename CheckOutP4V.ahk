...
RunBatchScript(){
	...
	if (currentTime= "8:55 PM"){
		Run("D:\Powershell_script\I38_P4CheckOutReport\stable\1.0.3_dual_server\CheckOutP4VServer1.bat")
	}
	if (currentTime= "8:57 PM"){
		Run("D:\Powershell_script\I38_P4CheckOutReport\stable\1.0.3_dual_server\CheckOutP4VServer2.bat")
	}
